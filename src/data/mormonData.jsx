export const mormonDatabase = [
  {
    id: "1-nephi-1",
    level: "Avanzado",
    title: "1 Nephi - Chapter 1",
    cover: "bg-indigo-100 text-indigo-700 border-indigo-200",
    description: "An account of Lehi and his wife Sariah, and his four sons, being called, (beginning at the eldest) Laman, Lemuel, Sam, and Nephi. The Lord warns Lehi to depart out of the land of Jerusalem.",
...
And when the Jews heard these things they were angry with him; yea, even as with the prophets of old, whom they had cast out, and stoned, and slain; and they also sought his life, that they might take it away. But behold, I, Nephi, will show unto you that the tender mercies of the Lord are over all those whom he hath chosen, because of their faith, to make them mighty even unto the power of deliverance.`
  },
  {
    id: "1-nephi-2",
    level: "Avanzado",
    title: "1 Nephi - Chapter 2",
    cover: "bg-blue-100 text-blue-700 border-blue-200",
    description: "Lehi takes his family into the wilderness by the Red Sea—They leave their property—Lehi offers a sacrifice to the Lord and teaches his sons to keep the commandments—Laman and Lemuel murmur against their father—Nephi is obedient and prays in faith.",
    content: `For behold, it came to pass that the Lord spake unto my father, yea, even in a dream, and said unto him: Blessed art thou Lehi, because of the things which thou hast done; and because thou hast been faithful and declared unto this people the things which I commanded thee, behold, they seek to take away thy life.
...
And if it so be that they rebel against me, they shall be a scourge unto thy seed, to stir them up in the ways of remembrance.`
...

  {
    id: "1-nephi-3",
    level: "Avanzado",
    title: "1 Nephi - Chapter 3",
    cover: "bg-emerald-100 text-emerald-700 border-emerald-200",
    description: "Lehi’s sons return to Jerusalem to obtain the plates of brass—Laban refuses to give the plates up—Nephi exhorts and encourages his brethren—Laban steals their property and attempts to slay them—Laman and Lemuel smite Nephi and Sam.",
    content: `And it came to pass that I, Nephi, returned from speaking with the Lord, to the tent of my father.
...
And after the angel had departed, Laman and Lemuel again began to murmur, saying: How is it possible that the Lord will deliver Laban into our hands? Behold, he is a mighty man, and he can command fifty, yea, even he can slay fifty; then why not us?`
  },
  {
    id: "1-nephi-4",
    level: "Avanzado",
    title: "1 Nephi - Chapter 4",
    cover: "bg-amber-100 text-amber-700 border-amber-200",
    description: "Nephi slays Laban at the Lord’s command and then secures the plates of brass by stratagem—Zoram chooses to join Lehi’s family in the wilderness.",
    content: `And it came to pass that I spake unto my brethren, saying: Let us go up again unto Jerusalem, and let us be faithful in keeping the commandments of the Lord; for behold he is mightier than all the earth, then why not mightier than Laban and his fifty, yea, or even than his tens of thousands?
...
And it came to pass that we took the plates of brass and the servant of Laban, and departed into the wilderness, and journeyed unto the tent of our father.`
  },
  {
    id: "1-nephi-5",
    level: "Avanzado",
    title: "1 Nephi - Chapter 5",
    cover: "bg-purple-100 text-purple-700 border-purple-200",
    description: "Sariah complains against Lehi—Both rejoice over the return of their sons—They offer sacrifices—The plates of brass contain writings of Moses and the prophets—The plates identify Lehi as a descendant of Joseph.",
    content: `And it came to pass that after we had come down into the wilderness unto our father, behold, he was filled with joy, and also my mother, Sariah, was exceedingly glad, for she truly had mourned because of us.
